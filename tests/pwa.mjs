...
const mainPortalVersion = mainApp.match(/\.\/lib\/portal-service\.js\?v=([a-f0-9]{12})/)?.[1];
const sharedSessionVersion = mainPortalService.match(/\.\/supabase\.js\?v=([a-f0-9]{12})/)?.[1];
assert.equal(mainPortalVersion, sharedSessionVersion);
