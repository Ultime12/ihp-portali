  ...
  modal({
    ...
    body: `
      <form class="form-stack" data-form="regulation" data-id="${esc(item?.id || "")}">
        ...
        <div class="form-group"><label for="regulation-content">İçerik</label><textarea class="field" id="regulation-content" name="content" required maxlength="8000">${esc(item?.content || "")}</textarea></div>
