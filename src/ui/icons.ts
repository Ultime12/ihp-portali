const paths = {
  ...
  briefcase: '<rect width="20" height="14" x="2" y="6" rx="2"/><path d="M8 6V4c0-1 .9-2 2-2h4c1.1 0 2 1 2 2v2"/><path d="M12 12v.01"/><path d="M2 12a18 18 0 0 0 20 0"/>',
...
export function icon(name: string, className = "icon") {
  return `<svg class="${className}" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">${paths[name] || paths.grid}</svg>`;
}
